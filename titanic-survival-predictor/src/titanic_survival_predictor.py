...
def TrainTitanicModel(df):
    ...
    PreservedModel(model, "titanic.pkl")
...
def DisplayInfo(title): # Reusable
    print("\n" + "="*70)
    print(title)
    print("="*70)
...
def CleanTitanicData(df):
    ...
    if "Age" in df.columns:
        ...
        # coerce = Invalid values get converted as Nan
    ...
    if "Fare" in df.columns:
        print("Fare colummn before preprocessing")
    ...
    if "Embarked" in df.columns:
        print("Embarked colummn before preprocessing")
    ...
    if "Sex" in df.columns:
        print("Sex colummn before preprocessing")
...
#   Description :   These is main pipeline controller
